...
const footerData = [
  {
    ...
    links: [
      ...
      { text: "Visit Our Stores", href: "#" },
      { text: "Menu - Takashimaya", href: "#" },
      { text: "Menu - Suntec", href: "#" },
      { text: "Menu - Capitaspring", href: "#" },
      { text: "Menu - UOB Plaza", href: "#" },
    ],
  },
  {
    title: "ONLINE STORE",
    links: [
      { text: "e-Gift Card", href: "#" },
  ...
  },
  {
    title: "CORPORATE",
    links: [
      { text: "Corporate Catering / Gift", href: "#" },
      { text: "Event Space", href: "#" },
      { text: "Matcha Appreciation & Wellness Workshop", href: "#" },
      { text: "Mobile Tea Bar", href: "#" },
      { text: "Wholesale", href: "#" },
    ],
  },
  {
    ...
    links: [
      { text: "CaterSpot", href: "#" },
      { text: "Cold Storage", href: "#" },
      { text: "Little Farms", href: "#" },
      { text: "Shopee", href: "#" },
      { text: "Lazada", href: "#" },
      { text: "Redmart", href: "#" },
    ],
    ...
    <FooterWrapper>
      <Container>
        ...
        <FooterAside>
          ...
          <PaymentList>
            <PaymentItem>
              <svg version="1.1" xmlns="http://www.w3.org/2000/svg" role="img" x="0" y="0" width="38" height="24" viewBox="0 0 165.521 105.965" aria-labelledby="pi-apple_pay">
